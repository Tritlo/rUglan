...
\hspace{2.0cm} $\bullet$ is.mpg.ruglan.data.iCalParser {\tiny \refdefined{is.mpg.ruglan.data.iCalParser}} \\
...
\label{is.mpg.ruglan.data.CalEvent.getColor()}}%end signature
\begin{itemize}
\item{{\bf  Returns} -- 
...
\label{is.mpg.ruglan.data.iCalParser.doInBackground(java.lang.String[])}}%end signature
}%end item
\item{ 
